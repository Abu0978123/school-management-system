    ...
    return (
        <div>
            <div className='container'>
                    ...
                    <div className="row row-content">
                        <div className='conatiner'>
                            <div class="col-12 mb-4 d-flex justify-content-center bg-success">
                                <h1 className='SMTPC text-white animate-fade-in-top-right p-2'>{t('SMTA')}</h1>
                            </div>
                            <br />
                        </div>
                ...
                <div>
                    <button className='btn btn-primary' onClick={sendMessage} >{t('SMTA')}</button>
                </div>
            </div>
        </div>
    )
